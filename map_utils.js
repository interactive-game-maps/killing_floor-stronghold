...
function onEachFeature(feature, layer, layer_group, list, list_name, create_checkbox) {
    ...
    if (feature.geometry.type == "Point") {
        ...
        if (feature.properties.image_id) {
            ...
            layer.bindPopup("<a href='https://steamuserimages-a.akamaihd.net/ugc/" + feature.properties.image_id + "/'><img src='https://steamuserimages-a.akamaihd.net/ugc/" + feature.properties.image_id + "/' width='500/' /></a>" + (feature.properties.description ? feature.properties.description : ""), { maxWidth: 500 });
        }

        if (feature.properties.video_id || feature.properties.image_id) {
            // rewrite url for easy copy pasta
